...
const OnboardingContainer = () => {
  return (
    <div className="flex flex-col items-center px-4 font-gotham">
      <AmanaLogo width={122} height={85} className="w-[122px] h-[85px] mb-4" />
      ...
      <p className="text-[16px] text-white text-center leading-relaxed max-w-3xl mb-10">
        Smart Accounts are the new standard for accessing and interacting with
        DeFi. They replace complicated crypto wallets, seed phrases, and gas
        fees with secure, intuitive experiences — just like the apps you already
        use
      </p>
