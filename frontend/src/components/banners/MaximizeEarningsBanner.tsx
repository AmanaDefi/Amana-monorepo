...
export function MaximizeEarningsBanner() {
    return (
        <div
            className='pl-8 pr-6 py-2 lg:pl-[80px] lg:pr-[80px] 2xl:pl-[146px] 2xl:pr-[126px] flex items-center w-full aspect-[440/176] max-h-[176px] sm:max-h-[200px] sm:aspect-[1728/200] bg-[linear-gradient(155deg,rgba(106,66,146,0.6)_0%,rgba(0,0,0,0)_25%,rgba(0,0,0,0)_50%,rgba(106,66,146,0.6)_78%,rgba(50,185,79,1)_110%)]'>
