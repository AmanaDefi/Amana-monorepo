  ...
  return (
    <section className="mt-[116px] lg:mt-[128px]">
      <motion.h1
        ...
        viewport={{ once: true }}
        className="text-white text-[24px] md:text-[36px] lg:text-[48px] leading-[-0.04em] text-center font-bold mb-6 md:mb-10"
      >
        Meet Our Team
      </motion.h1>
        ...
        >
          ...
          >
            {teamData.map((member, index) => (
              <div key={member.id} className="w-full flex-shrink-0 px-8">
                <motion.div
                  ...
                  viewport={{ once: true }}
                  whileHover={{ y: -10 }}
                  className="mx-auto max-w-[358px] rounded-[24px] px-7 py-10 shadow-lg bg-[#0D1117] text-center"
                >
                  <motion.div
                    initial={{ scale: 0.8 }}
                    whileInView={{ scale: 1 }}
            ...
            {teamData.map((member, index) => (
              ...
              >
                <motion.div
                  ...
                  viewport={{ once: true }}
                  whileHover={{ y: -10 }}
                  className="mx-auto max-w-[450px] rounded-[24px] px-6 md:px-7 py-8 md:py-10 shadow-lg bg-[#0D1117] text-center"
                >
                  <motion.div
                    initial={{ scale: 0.8 }}
                    whileInView={{ scale: 1 }}
                  ...
                  <div className="flex flex-row justify-between items-center">
                    <div className="flex flex-col gap-2 items-start justify-start">
                      <h3 className="text-white text-[20px] md:text-[22px] lg:text-[24px] font-medium">
                        {member.name}
                      </h3>
                      <p className="text-gray-400 text-[14px] md:text-[15px] lg:text-[16px] font-normal">
                        {member.position}
                      </p>
                    </div>
