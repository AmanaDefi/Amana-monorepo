      ...
      <Dialog as="div" className="relative z-10" onClose={setShowModal}>
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center md:p-0">
            ...
            >
              <Dialog.Panel
                className={`w-full md:min-w-[500px] md:w-fit relative transform overflow-hidden rounded-lg bg-customNeutral200 border border-customNeutral100 px-8 py-9 transition-all text-white ${classNames}`}
              >
