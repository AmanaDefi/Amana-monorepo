...
const InvestBlock = () => {
  ...
  return (
    <div className="hidden md:flex font-gotham pl-[44px] pr-[40px] py-[18px]  items-center justify-between rounded-[16px] bg-[rgba(20,23,31,0.15)] backdrop-blur-[20px] shadow-md before-gradient-border">
