    ...
    <AnimatePresence>
      {isShownList && (
        <motion.div
          ...
          className={`z-10 ${minWidth && "md:min-w-[526px] !w-[90vw]"} rounded-2xl absolute top-14 flex flex-col gap-2 bg-[#14171F] shadow-[0_4px_6px_0_rgba(0,0,0,0.15)] p-6 ${alignment === "right" ? "md:right-0 -left-[160px]" : "left-0"}`}
          role="menu"
        >
          {isIconButton && (
