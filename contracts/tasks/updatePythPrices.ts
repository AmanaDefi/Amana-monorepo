...
const PYTH_CONTRACT_ADDRESS = "0x2880aB155794e7179c9eE2e38200202908C17B43"; // Zetachain
// const PYTH_CONTRACT_ADDRESS = "0x8250f4aF4B972684F7b336503E2D6dFeDeB1487a"; // Base
const priceIds = [
