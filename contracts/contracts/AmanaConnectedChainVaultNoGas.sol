...
contract AmanaConnectedChainVaultNoGas is AmanaVaultBase {
    ...
    function _divestFromStrategy(
        ...
        (address gasZRC20, uint256 gasFee) = IZRC20(address(asset()))
            .withdrawGasFeeWithGasLimit(gasLimitForCall);
        if (address(asset()) != gasZRC20) {
            //swap asset into gasFee - exactAmountOut
