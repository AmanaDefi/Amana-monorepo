...
contract ConvexERC20StrategyWithSwap is ERC20StrategyParent {
    ...
    function initialize(
        ...
        USDe_ADDRESS = 0x4c9EDD5852cd905f086C759E8383e09bff1E68B3; // USDe address on Ethereum
    }
    ...
    function _depositFundsIntoYieldSource(
        ...
        uint256[] memory amounts = new uint256[](2);
        amounts[inputTokenIndex] = amountOut;
    ...
    function _withdrawFundsFromYieldSource(
        ...
        console.log("swapHelper address", address(swapHelper));
        // Swap input token to receipt token (sUSN) via Uni v4
        amountWithdrawn = ISwapHelper(swapHelper).swap(
            USDe_ADDRESS,
            usdeAmountWithdrawn,
            address(inputToken),
            10000,
        ...
        console.log("Amount out after withdrawal", amountWithdrawn);
    }
