...
export const vaultTestMatrix = [
  {
    ...
    txConfig: {
      originChainId: 42161,
      originGasToken: ZC_ETH_ARB_ADDRESS,
      originERC20Input: ethers.constants.AddressZero,
      originZRC20Input: ZC_ETH_ARB_ADDRESS, // cross chain deposit will use this

      crossChainDepositAmount1: ethers.utils.parseUnits("0.014", 18),
