...
describe("AmanaConnectedChainVault Tests", function () {
  ...
  //   const investEvent = receipt.events?.find((e) =>
  //     e.event === "CrossChainInvestSent"
  //   );

  //   expect(investEvent).to.exist;
  //   const { args } = investEvent!;
  //   const emittedAmount = args?.amount;
  //   await simulateConfirmDeposit(amanaVault, gatewaySigner, user1, emittedAmount, 0, 1, 1, strategyConfig.address, strategyConfig.chainId, strategyConfig.gasToken);
  //   const totalShares = await amanaVault.balanceOf(await user1.getAddress());
  ...
  //   await simulateConfirmWithdrawToConnChain(amanaVault, gatewaySigner, user1, userExpectedAmountWithdrawn, userMaxRedeem, emittedAmount, 2, 2, txConfig.originZRC20Input, txConfig.originChainId, txConfig.originERC20Input, vaultConfig.asset, strategyConfig.address, strategyConfig.chainId, strategyConfig.gasToken, txConfig.slippage);
  //   const totalShares = await amanaVault.balanceOf(await user1.getAddress());
  //   expect(totalShares).to.eq(0);
  ...
  //   await simulateConfirmRedeemToAnyToken(amanaVault, gatewaySigner, user1, withdrawToken, expectedAmountWithdrawn, totalShares, emittedAmount, 2, 2, vaultConfig.asset, strategyConfig.address, strategyConfig.chainId);
  ...
  //   // Find the CrossChainInvestSent event
  //   let investEvent = receipt.events?.find((e) =>
  //     e.event === "CrossChainInvestSent"
  //   );

  //   expect(investEvent).to.exist;
  //   let { args } = investEvent!;
  //   let emittedAmount = args?.amount;
  //   const initialTotalAssets = emittedAmount;
  //   await simulateConfirmDeposit(amanaVault, gatewaySigner, user1, initialTotalAssets, 0, 1, 1, strategyConfig.address, strategyConfig.chainId, strategyConfig.gasToken);
  ...
  //   // Find the CrossChainInvestSent event
  //   let investEvent2 = receipt2.events?.find((e) =>
  //     e.event === "CrossChainInvestSent"
  //   );

  //   expect(investEvent2).to.exist;
  //   let emittedAmount2 = investEvent2!.args?.amount;
  ...
  //   await simulateConfirmDeposit(amanaVault, gatewaySigner, user2, emittedAmount, emittedAmount.add(profit), 2, 2, strategyConfig.address, strategyConfig.chainId, strategyConfig.gasToken);

  //   const updatedTotalAssets = initialTotalAssets.add(emittedAmount).add(profit);
  ...
  //   const { args } = investEvent!;
  //   const emittedAmount = args?.amount;
  //   simulateConfirmDeposit(amanaVault, gatewaySigner, user1, emittedAmount, 0, 1, 1, strategyConfig.address, strategyConfig.chainId, strategyConfig.gasToken);
  ...
  //   // Find the CrossChainInvestSent event
  //   const investEvent2 = receipt2.events?.find((e) =>
  //     e.event === "CrossChainInvestSent"
  //   );

  //   expect(investEvent2).to.exist;
  //   const { args2 } = investEvent2!;
  //   const emittedAmount2 = args2?.amount;
  //   await simulateConfirmDeposit(amanaVault, gatewaySigner, user2, emittedAmount2, txConfig.crossChainDepositAmount1, 2, 2, strategyConfig.address, strategyConfig.chainId, strategyConfig.gasToken);
