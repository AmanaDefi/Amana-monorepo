...
- Update output error logic to show zero output and only show the "Swap route not found" message when it's needed, don't let it blink for even a 0ms when calculation is in progress and it's not needed.
